...
mvn install:install-file -Dfile=*PATH*.jar -DgroupId=org.esclasslibrary -DartifactId=esclasslibrary -Dversion=1.2 -Dpackaging=jar

Dove *PATH* è da sostituire con il filepath del file ESClassLibrary-1.11.jar che trovate nella cartella esserver/lib.
