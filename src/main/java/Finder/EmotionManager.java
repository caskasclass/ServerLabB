 ...
 * lettura delle informazioni relative alle emozioni legate dei brani.
 */
public class EmotionManager implements EmotionManagerInterface {
    ...
    /**
     * Ottiene tutti i commenti associati a una traccia specifica.
     *
     * @return Un'ArrayList contenente oggetti di tipo CommentSection, ciascuno
     *         rappresentante un commento
     *         associato alla traccia specificata.
     */
